...
class DeepSeekChatApp:
    def __init__(self, root):
        ...
        # 加载配置
        self.CONFIG_FILE = "o1config.json"
        ...
        # 模型选择
        self.models = ["o1-mini","o1"]  # 可用的模型列表
        ...
        # 初始化 PromptsManager
        self.prompts_manager = PromptsManager(root, main_app=self, main_input=self.user_input,show_copysystem_button=False)
    ...
    def load_selected_history(self):
        ...
        try:
            with open(file_path, "r", encoding="utf-8") as f:
                ...
                messagebox.showinfo("成功", "历史对话已加载（系统提示词不加载）")
    ...
    def show_timeout_popup(self):
        ...
        # 添加提示信息
        message = "等待时间过长，请访问官网确认 AI 服务是否可用。"
